...
export const WorkRight: React.FC<WorkRightProps> = ({ children, progress }) => {
    ...
    return (
        <div className="flex flex-1 items-center justify-center h-screen" style={{ transform: `translateY(${translateY}px)` }}>
...
export const WorkLink: React.FC<WorkLinkProps> = ({ href, children }) => {
    return (
        <Link href={href} target="_blank" className="underline underline-offset-8 decoration-1">
            {children}
        </Link>
    );
};