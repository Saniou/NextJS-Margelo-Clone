...
const Testimonials: React.FC = () => {
    return (
        <>
        <Carousel className='bg-black text-center text-white py-10 lg:py-20'>
            <CarouselItem index={0}>
                <Review by='Axel (Showtime)'>
                Showtime both share the love for high-quality software, the passion for building something people want and the ambition of always doing our best. 10/10 would recommend working with Marc and his team.
                </Review>
            </CarouselItem>
